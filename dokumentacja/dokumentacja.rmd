...
należy założyć, że każda wideokonferencja to zmieniony zasób w zmiennej `JITSI_URL`, oraz różna liczba uczestników to zmienna `BOT_COUNT-1` (gdzie dodatkowa
osoba to my jako uczestnik).

## Wyniki oraz spostrzeżenia sprzed optymalizacji za pomocą Octo

> Przy pierwotnym testowaniu wynikło, że musimy zmienić sposób testowania. Nie zawrzemy tutaj naszych potknięć które były po drodze.
