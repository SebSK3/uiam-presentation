...
Kod odpowiedzialny za wybór mostka w przypadku tej funkcji składa się z wykorzystania kilku funkcji pomoczniczych, które starają się znaleźć najlepszy mostek dla użytkownika - funckje te są również wykorzystane w innych metodach wyboru mostka, jednak te nie zostały przez nas przetestowane.
...
TODO: nie wiem w sumie czy to wszystko, może można coś więcej tu opisać ale nie mam pomysłu tbh
...
TODO: nie wiem czy serwer z publicznym IP to narzędzie ale też jest potrzebny
...
TODO: wywalić helma z poniższego rysunku, nie jest używany

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{./res/124-samo-postawienie-tailscale.png}
