...
* poziom stresu Videobridge - Aktualny poziom naprężeń na moście, gdzie 0 oznacza brak obciążenia, a 1 pełne wykorzystanie zasobów (chociaż wartości większe niż 1 są dopuszczalne).
...
<!-- TODO: in order to check deeper into one of the charts just do: -->
```{r run_plot, echo=FALSE, fig.width=8, fig.height=5, fig.cap="Aaa"}
# plot_enhanced("./stress-results/single/1conf-3pers/CPU-data.csv")
```
...
```{r fig.pos="H", echo=FALSE, fig.width=12, fig.height=6, fig.cap="Scenariusz 3 - 3 konferencje po 10 uczestników"}
